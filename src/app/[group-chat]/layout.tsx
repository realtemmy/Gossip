...
export default function ChatLayout({ children }: ChatLayoutProps) {
    ...
    const [channels] = useState<Channel[]>([
        { id: 'general', name: 'general', type: 'channel', members: 42, isActive: true },
        { id: 'design', name: 'design', type: 'channel', members: 28, unread: 3 },
        { id: 'engineering', name: 'engineering', type: 'channel', members: 15 },
        { id: 'marketing', name: 'marketing', type: 'channel', members: 8, unread: 1 },
                ...
                <ScrollArea className="flex-1">
                    <div className="px-4 py-2">
                        <div className="flex items-center justify-between mb-3">
                            ...
                            <Button variant="ghost" size="sm" className="text-slate-400 hover:text-white hover:bg-slate-800 h-6 w-6 p-0">
                        ...
                        <div className="space-y-1">
                            {channels.filter(c => c.type === 'channel').map(channel => (
                                <Button
                                    ...
                                    className={`w-full justify-between px-3 py-2 h-auto text-left font-normal ${activeChannel === channel.id
                    ...
                    <div className="px-4 py-2">
                        <div className="flex items-center justify-between mb-3">
                            <h2 className="text-sm font-semibold text-slate-300 uppercase tracking-wide">Direct Messages</h2>
                            <Button variant="ghost" size="sm" className="text-slate-400 hover:text-white hover:bg-slate-800 h-6 w-6 p-0">
                                <Plus className="h-4 w-4" />
                            </Button>
                        </div>
